...
glBegin(GL_LINE_LOOP);
	  glVertex2f(400,300);
	  glVertex2f(550,300);
	  glVertex2f(725,475);//UP ROOF
	  glVertex2f(600,475);
	  glEnd();
     glBegin(GL_LINE_LOOP);//side roof
	glVertex2f(550,300);
	glVertex2f(725,475);
	glVertex2f(800,420);
	glVertex2f(625,225);
